...
project-headline: A command-line tool that automates footnote-checking and binder assembly for expert reports, cutting the common case from ~60 to ~25 seconds per footnote.
tags:
  - "all"
  - "software"
  - "tooling"
